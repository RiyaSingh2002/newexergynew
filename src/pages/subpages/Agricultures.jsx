  ...
  return (
    <div style={styles.container}>
      ...
      <div style={{ ...styles.paragraphBox, top: '160px', left: '50px', marginBottom: '20px' }}>
        <h1 style={styles.heading}>AGRICULTURE</h1>
        <p style={styles.paragraph}>
          ...
          imagery, aerial drones, and loT sensors to capture high-resolution data on <br />
          crop health, vegetation indices, and soil characteristics. Our advanced <br />
          analytics and machine learning algorithms enable precise yield prediction, <br />
          pest and disease detection, and optimized resource allocation for precision <br />
          farming. By integrating weather data, soil moisture monitoring, and <br />
          geospatial insights, we empower farmers and agribusinesses to enhance <br />
          productivity, minimize environmental impact, and drive sustainable <br />
